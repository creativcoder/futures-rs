...
[stream-poll]: https://docs.rs/futures/0.1.6/futures/future/stream/trait.Stream.html#tymethod.poll
...
ready. For this, the [`result`], [`err`], and [`ok`] functions suffice. The
...
[`result`]: https://docs.rs/futures/0.1.6/futures/future/fn.result.html
[`ok`]: https://docs.rs/futures/0.1.6/futures/future/fn.ok.html
[`err`]: https://docs.rs/futures/0.1.6/futures/future/fn.err.html
...
[`oneshot`]: https://docs.rs/futures/0.1.6/futures/fn.oneshot.html
...
[`Complete`]: https://docs.rs/futures/0.1.6/futures/sync/oneshot/struct.Canceled.html
...
[`Canceled`]: https://docs.rs/futures/0.1.6/futures/sync/oneshot/struct.Canceled.html
...
[`channel`]: https://docs.rs/futures/0.1.6/futures/sync/oneshot/fn.channel.html
[`Sender`]: https://docs.rs/futures/0.1.6/futures/sync/oneshot/struct.Sender.html
